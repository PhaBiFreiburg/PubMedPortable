...
if __name__=="__main__":
    ...
    parser.add_option("-e", "--e_year", dest="e", help="year of the index to end parsing (default: 2018)", default=2018)
    parser.add_option("-x", "--index", dest="x", action="store_true", default=False, help="Create Xapian index first turns on indexing step (default: False)")
